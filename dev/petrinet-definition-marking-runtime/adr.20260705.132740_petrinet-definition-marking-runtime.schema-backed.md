...
```json
{
  ...
  "source_artifacts": [
    ...
    },
    {
      ...
      "path": "docs/implementation/workflow-petri-net-executor-first-slice.20260705.102506.md",
      "relationship": "reference",
      "role": "VULCAN"
    },
    {
      "note": "Current implementation report; evidence/context only, not acceptance authority for this draft.",
      "path": "docs/implementation/workflow-adapter-dependency-encapsulation.20260705.105604.md",
      "relationship": "reference",
      "role": "VULCAN"
    },
    {
