...
name: archon
description: |
  Use when the user wants to run Archon workflows, create workflows or
  commands, initialize or configure Archon, or manage Archon settings.
  Common triggers include "use archon", "run archon", "archon workflow",
  "create a workflow", "new command", "archon setup", "archon config", and
  "archon init". Archon runs AI workflows in isolated git worktrees and this
  skill covers workflow/command YAML authoring plus repo initialization.
