...
| `docs/templates/` is the reusable template namespace. | `docs/templates/templates.00.md`; `docs/architecture/architecture.templates.md`; `docs/adr/adr.templates.draft.md` | Current proposal now includes the controlling template draft as source context and does not accept it wholesale. |
