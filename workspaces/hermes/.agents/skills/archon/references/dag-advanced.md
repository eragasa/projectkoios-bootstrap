...
Preload domain knowledge into a node via Codex skills.
...
- id: generate
  ...
  skills:
    - remotion-best-practices          # Must be installed in .agents/skills/
...
# Write .agents/skills/my-skill/SKILL.md with frontmatter
```
