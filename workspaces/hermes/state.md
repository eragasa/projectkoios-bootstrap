...
HERMES_USER to choose whether to ask ATHENA for a bounded PM-1/PM-2 implementation brief based on `docs/architecture/architecture.project-management.md`, pause the project-management track, stop/defer the ADR/schema planning track, or activate another explicitly bounded workflow item.
