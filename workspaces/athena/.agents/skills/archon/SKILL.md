...
name: archon
description: |
  Use for Archon workflows, setup/config, repo init, and workflow/command authoring.
  Triggers: run Archon (“use archon to”, “run archon”, “archon workflow”); create workflows/commands (“create/write a workflow”, “make/new command”, “archon workflow yaml”); setup/init (“set up/install archon”, “how to use archon”, “archon init”, “add archon to repo”); config (“archon config”, “change archon settings”).
  Archon runs AI workflows in isolated git worktrees and manages workflow YAMLs, command files, and config.
