...
Cohesion: 0.13
Nodes (14): ADR20260628: Establish projectkoios-bootstrap as the three-harness meta-harness, Alternatives considered, Boundaries, Consequences, Context, Decision, Everything in one agent tool (opencode only), Harness responsibilities (+6 more)
...
Cohesion: 0.20
Nodes (9): Architecture, Archon — architecture and design, Commands, Goose — knowledge management, Harnesses, opencode — build and runtime, Prerequisites, projectkoios-bootstrap (+1 more)
...
Cohesion: 0.29
Nodes (6): ADR20260629: Install Archon via curl rather than Homebrew, Consequences, Context, Decision, Rationale, Status
