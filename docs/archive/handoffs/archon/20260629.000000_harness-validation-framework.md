...
This repo (`projectkoios-bootstrap`) manages shared agent configs across four harnesses (Hermes, archon, opencode, goose). Each harness has an `AGENTS.md` that defines its role, scope, and behavior. There are also:
