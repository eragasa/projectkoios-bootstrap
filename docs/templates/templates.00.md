...
This is the namespace index for bootstrap template documents.

## Scope

These notes describe reusable template content, instructions, and boilerplate.
They live under `docs/templates/`.
