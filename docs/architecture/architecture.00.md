...
| [architecture.canonical-workspace-state-and-next-action-protocol](architecture.canonical-workspace-state-and-next-action-protocol.md) | [adr.workspaces](../adr/adr.workspaces.20260705.105021Z.md) |
