...
| [architecture.canonical-workspace-state-and-next-action-protocol](architecture.canonical-workspace-state-and-next-action-protocol.md) | [adr.20260704.162218_canonical-workspace-state-next-action-protocol](../adr/adr.20260704.162218_canonical-workspace-state-next-action-protocol.md) |
