...
This is the bootstrap architecture index for the ADR architecture surface.

## Scope

It groups the architecture notes that describe ADR schema, naming, lifecycle, and related control surfaces inside `projectkoios-bootstrap`.
