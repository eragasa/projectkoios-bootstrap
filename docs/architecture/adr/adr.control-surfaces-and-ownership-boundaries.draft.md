...
- ATHENA: `docs/AAR/` should stay explicitly non-authoritative and never act as a source of truth for routing or decision state; otherwise process notes can start competing with the surfaces they describe.
